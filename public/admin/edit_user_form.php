...
$id = $_GET['GetId'];
$sql = "SELECT id,f_name,l_name,email from users WHERE id = '".$id."'";
...
<div class=" col-11 ">
	<form method="POST" action="../../app/updateUser.php?GetId=<?php echo $id; ?>">
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-2 mx-auto">
        <button type="submit" name="btn_edit" class="btn btn-primary btn-block"> Update </button>
    </div> 
